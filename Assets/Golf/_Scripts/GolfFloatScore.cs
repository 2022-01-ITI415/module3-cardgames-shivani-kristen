...
public class GolfFloatScore : MonoBehaviour {
    ...
    public void Init(List<Vector2> ePts, float eTimeS = 0, float eTimeD = 1)
    {
        ...
        if (ePts.Count == 1)  { // If therrs's only one point
            // ... then just go there.
        ...
        state = eFSState.Pre; // set it to pre state, ready to start moving
    }
    public void FSCallback(GolfFloatScore fs)
    {
    ...
    void Update()
    {
        ...
        else
        {
            ...
            {
                // If frontSizes has values in it 
                // ...then adjust the frontSize of this GUITExt
