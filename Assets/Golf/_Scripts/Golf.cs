...
public class Golf : MonoBehaviour {
	...
	void LayoutGame()
	{
		...
		foreach (SlotDef tSD in layout.slotDefs)
		{
			...
			cp.layoutID = tSD.id;
			cp.slotDef = tSD;
			// CardGolfs in the tableau have the state CardState.tableu 
	...
	public void CardClicked(CardGolf cd)
	{
		...
		switch (cd.state)
		{
			...
			case eCardState.drawpile:
                ...
                GolfFloatScoreHandler(eScoreEvent.draw);
				break;
			...
			case eCardState.tableau:
				...
				GolfFloatScoreHandler(eScoreEvent.mine);
				break;
		}
	...
	void GameOver(bool won)
    {
		...
		if (won) {
			...
			GolfFloatScoreHandler(eScoreEvent.gameWin);
        } else {
			...
			GolfFloatScoreHandler(eScoreEvent.gameLoss);
		}
	...
	void GolfFloatScoreHandler(eScoreEvent evt)
    {
		List<Vector2> fsPts;
		switch (evt)
        {
			...
			case eScoreEvent.mine: // Remove a mine card
				...
				fsPts.Add(fsPosMid);
				fsPts.Add(fsPosRun);
				fs = Scoreboard.S.CreateGolfFloatScore(ScoreManager.CHAIN, fsPts);
