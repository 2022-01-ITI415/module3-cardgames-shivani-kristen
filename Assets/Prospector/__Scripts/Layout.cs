...
public class Layout : MonoBehaviour
{
    ...
    // SlotDef references
    public List<SlotDef> slotDefs; // all the slot defs for Row0 - Row3
    public SlotDef drawPile;
    public SlotDef discardPile;
    // this holds all fo the possible names for the layers set by layerID
    ...
    public void ReadLayout(string xmlText)
    {
        ...
        for(int i = 0; i < slotsX.Count; i++) {
            ...
            if(slotsX[i].HasAtt("type")) {
                // if this <slot> has a type attribute to parse it
            ...
            // this convers the number of the layerID into a text layerName
